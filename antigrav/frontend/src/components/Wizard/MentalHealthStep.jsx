    ...
    return (
        <div className="max-w-xl mx-auto animate-fade-in-up">
            ...
            <div className="relative">
                ...
                {/* Content Container */}
                <div className="bg-white dark:bg-slate-800 p-8 md:p-10 rounded-[2.5rem] shadow-[0_20px_50px_rgba(231,229,228,0.5)] dark:shadow-none border border-stone-100 dark:border-slate-700 space-y-8 relative z-10 transition-colors">
                    ...
                    <div className="relative z-10">
                        <div className="flex justify-between items-end mb-4">
                            <label className="font-bold text-stone-700 dark:text-stone-300 text-lg flex items-center gap-2">
                                ...
                                <InfoTooltip
                                    title="Stress Level"
                                    content="Self-reported perceived stress. High chronic stress releases cortisol, affecting heart and metabolic health."
                                    range="0 (Zen) - 10 (High)"
                                    testName="Perceived Stress Scale (PSS)"
                                    location="Self-Assessment / Psychologist"
                                />
                            </label>
                    ...
                    <div className="relative z-10">
                        <div className="flex justify-between items-end mb-4">
                            <label className="font-bold text-stone-700 dark:text-stone-300 text-lg flex items-center gap-2">
                                ...
                                <InfoTooltip
                                    title="Workload"
                                    content="Volume and intensity of professional/personal tasks. High workload correlates with burnout."
                                    range="0 (Light) - 10 (Heavy)"
                                    testName="Occupational Stress Index"
                                    location="Self-Assessment / Workplace Audit"
                                />
                            </label>
                    ...
                    <div className="relative z-10">
                        <div className="flex justify-between items-end mb-4">
                            <label className="font-bold text-stone-700 dark:text-stone-300 text-lg flex items-center gap-2">
                                ...
                                <InfoTooltip
                                    title="Sleep Quality"
                                    content="Restfulness and duration of sleep. Poor sleep disrupts hormones and increases heart disease risk."
                                    range="0 (Poor) - 10 (Excellent)"
                                    testName="Polysomnography (Sleep Study)"
                                    location="Sleep Clinic / Home Sleep Test"
                                />
                            </label>
